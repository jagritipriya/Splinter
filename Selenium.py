...
class Selenium:
    def search(self,api_key, restaurants):
    ...
    def getReviews(self,api_key, restaurants):
        header = {'Accept': 'application/json', 'user_key': api_key}
        for restaurant in restaurants:
    ...
    def run(self,restaurant_url,restaurant):
        ...
        f = open("./Restaurant_Reviews/"+restaurant + '.txt','wb+')
        count = 0
        count_expand = 0
