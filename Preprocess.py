...
class PreProcessData:
    def remove_punctuaion(self,string_list):
        print("Inside remove_punctuation")
        import string
    ...
    def text_to_numbers(self,string_list):
    ...
    def shuffle_dataset(self,dataframe):
        ...
        data_label = []
        data_tuples = tuple()
        reviews = dataframe['review'][:50000]
        labels = dataframe['label'][:50000]
        ...
        return data_review[:100],data_label[:100],len(self.get_unique_words(data_review[:100]))

    def one_hot_encode(self,string_list):
        print("Inside one_hot_encode")
        ...
        for line in numerical_string:
            one_hot_encoded = np.zeros(len(unique_words))
            for index in line:
